function [confusionMatrix,accuracy] =  classifiy677_hwk5(X,y,options)
%function [confusionMatrix,accuracy] =  classifiy677_hwk5(Xdata,y,options)
% Input:
...
%      options.method = {'LogisticRegression', 'KNN', 'ClassificationTree',
